    ...
    <section className="relative min-h-[100svh] md:h-[930px] bg-[#18191E] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          quality={90}
        />
        {/* Gradient sutil apenas para legibilidade do texto à esquerda */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#18191E]/70 via-[#18191E]/30 to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-t from-[#18191E]/60 via-transparent to-transparent" />
      </div>
      ...
      <div className="relative h-full flex flex-col justify-center max-w-[1328px] mx-auto px-6 w-full">
        {/* Main Content */}
