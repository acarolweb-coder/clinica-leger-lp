...
const techniques = [
  {
    ...
    description: (
      <>
        Consiste na aplicação de <strong className="text-[#8C4821] font-medium">substâncias biocompatíveis, aprovadas pela ANVISA</strong>, em pontos estratégicos do bumbum para harmonizar o formato e melhorar a projeção de forma natural. O procedimento é <strong className="text-[#8C4821] font-medium">realizado em consultório</strong> e com anestesia local. É <strong className="text-[#8C4821] font-medium">totalmente personalizado</strong> e começa com uma análise da anatomia da paciente e da escuta de suas queixas, permitindo ao Dr. Roberto Chacur definir o planejamento mais adequado de contorno e proporção corporal.
      </>
    ),
    indications: [
  ...
  },
  {
    ...
    description: (
      <>
        Método avançado para o tratamento da celulite, criado pelo Dr. Roberto Chacur e <strong className="text-[#8C4821] font-medium">premiado internacionalmente como melhor tratamento corporal do mundo</strong>. Consiste na liberação das fibras que puxam a pele para dentro e formam as depressões da celulite, associada ao <strong className="text-[#8C4821] font-medium">bioestímulo de colágeno</strong> para melhorar a textura e a qualidade da pele. Realizada em consultório, com anestesia local, permite suavizar irregularidades de <strong className="text-[#8C4821] font-medium">forma segura e personalizada</strong>.
      </>
    ),
    indications: [
...
export default function Techniques() {
  return (
    <section id="tecnicas" className="bg-[#FFF4EE] py-16 md:py-32">
            ...
            <ScrollReveal key={i} delay={i * 0.15}>
              <div className="rounded-3xl overflow-hidden border border-[#B6A095]/15 bg-white group hover:shadow-xl hover:shadow-[#B6A095]/10 transition-all duration-700">
                <div className="grid md:grid-cols-2">
                  ...
                  >
                    <h3 className="text-2xl md:text-[2rem] font-semibold text-[#8C4821] leading-[1.15] mb-4">
                      {t.title}
                    </h3>

                    <p className="text-[13px] text-[#433532]/70 font-light leading-[1.7]">
                      {t.description}
                    </p>
        ...
        <ScrollReveal>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <a
              ...
              className="cta-premium inline-flex w-full md:w-auto justify-center items-center gap-2 text-[11px] tracking-[0.15em] md:tracking-[0.2em] uppercase font-semibold text-white bg-gradient-to-r from-[#72311A] to-[#8C4821] hover:from-[#8C4821] hover:to-[#A0562F] border border-[rgba(255,218,199,0.2)] hover:border-[rgba(255,218,199,0.48)] px-8 md:px-10 py-[25px] rounded-full transition-all duration-500 hover:shadow-[inset_0_0_2px_0_rgba(222,134,84,0.98),0_8px_32px_rgba(140,72,33,0.3)] focus-visible:ring-2 focus-visible:ring-[#8C4821] group flex-shrink-0 self-start md:self-center"
            >
