      ...
      <div className="max-w-[1328px] mx-auto px-6 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 md:grid-rows-[auto_1fr_auto] gap-6 md:gap-8">
          ...
          <ScrollReveal className="md:col-span-6 md:row-start-1 order-1 md:order-2 flex flex-col justify-end">
            ...
            {/* CRM credentials */}
            <div className="flex flex-col sm:flex-row gap-x-6 gap-y-1.5 pb-6 border-b border-white/[0.08]">
          ...
          <ScrollReveal delay={0.25} className="md:col-span-12 md:row-start-3 order-4 mt-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-5">
              ...
              <div className="group relative aspect-[16/10] rounded-xl overflow-hidden cursor-pointer transition-all duration-500 hover:shadow-xl hover:shadow-[#8C4821]/10 bg-gradient-to-br from-[#2A2226] to-[#1E1A1C]">
          ...
          <ScrollReveal delay={0.35} className="md:col-span-12 md:row-start-4 order-5">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 pt-8 mt-2 border-t border-white/[0.08]">
              ...
              <a
                ...
                className="cta-premium inline-flex items-center gap-2 text-[11px] tracking-[0.2em] uppercase font-semibold text-white bg-gradient-to-r from-[#72311A] to-[#8C4821] hover:from-[#8C4821] hover:to-[#A0562F] border border-[rgba(255,218,199,0.2)] hover:border-[rgba(255,218,199,0.48)] px-10 py-[22px] rounded-full transition-all duration-500 hover:shadow-[inset_0_0_2px_0_rgba(222,134,84,0.98),0_8px_32px_rgba(140,72,33,0.3)] focus-visible:ring-2 focus-visible:ring-[#8C4821] group/cta flex-shrink-0 self-start md:self-center"
              >
