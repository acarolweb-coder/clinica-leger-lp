    ...
    <section className="relative bg-[#FFF4EE] py-24 md:py-32 overflow-hidden">
      ...
      <div className="max-w-[1328px] mx-auto px-6 relative">
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div>
            ...
            <ScrollReveal delay={0.4}>
              ...
              <a
                ...
                className="cta-premium inline-flex w-full md:w-auto justify-center items-center gap-2 text-[10px] md:text-[11px] tracking-[0.12em] md:tracking-[0.2em] uppercase font-semibold text-white bg-gradient-to-r from-[#72311A] to-[#8C4821] hover:from-[#8C4821] hover:to-[#A0562F] border border-[rgba(255,218,199,0.2)] hover:border-[rgba(255,218,199,0.48)] px-6 md:px-10 py-[22px] md:py-[25px] rounded-full transition-all duration-500 hover:shadow-[inset_0_0_2px_0_rgba(222,134,84,0.98),0_8px_32px_rgba(140,72,33,0.3)] focus-visible:ring-2 focus-visible:ring-[#8C4821] group"
              >
          ...
          <ScrollReveal direction="right" className="order-first md:order-none">
            <div className="grid grid-cols-2 gap-3">
              ...
              {/* Mini stat cards */}
              <div className="bg-[#8C4821]/[0.05] border border-[#8C4821]/10 rounded-xl p-3 md:p-5 text-center group hover:border-[#8C4821]/20 transition-colors duration-300">
                <span className="block text-xl md:text-2xl font-bold text-[#8C4821] leading-none mb-0.5 md:mb-1">
                  +5.000
                </span>
